...
| clamav.nodeSelector | object | `{}` | The node selector for the clamav service |
| clamav.tolerations | list | `[]` | The tolerations for the clamav service |
...
| clamavMirror.nodeSelector | object | `{}` | The node selector for the clamav-mirror service |
| clamavMirror.tolerations | list | `[]` | The tolerations for the clamav-mirror service |
